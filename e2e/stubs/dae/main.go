...
`)
	case "export":
		if len(args) > 1 && args[1] == "outline" {
			fmt.Print(`{"version":"v1.0.6","structure":[{"name":"Global","mapping":"global","structure":[{"name":"LogLevel","mapping":"log_level","defaultValue":"info"},{"name":"WanInterface","mapping":"wan_interface"},{"name":"DialMode","mapping":"dial_mode","defaultValue":"domain"},{"name":"TproxyPort","mapping":"tproxy_port","defaultValue":"12345"},{"name":"TlsImplementation","mapping":"tls_implementation","defaultValue":"tls"},{"name":"CheckInterval","mapping":"check_interval","defaultValue":"30s"}]}]}`)
		}
	}
}
