import{$t as e,A as t,An as n,Cn as r,Ct as i,Dt as a,En as o,Ft as s,Gn as c,Hn as l,In as u,Jn as d,Jt as f,Kn as p,Mt as m,N as h,Nt as g,On as _,Ot as v,P as y,Pn as b,Pt as x,Qt as S,Rn as C,S as w,Sn as T,T as E,Tt as D,Yt as O,Zt as k,_ as A,_n as j,an as M,bn as N,cn as ee,dr as P,en as te,f as ne,fn as F,ft as I,gn as L,i as re,j as R,jt as ie,k as ae,lr as z,nn as oe,pt as B,qn as V,rr as H,sr as U,tn as se,ur as ce,vn as W,wn as G,wt as K,x as le,xn as ue,xt as de,y as fe,yn as q,yt as pe,zn as J,zt as me}from"./client-BPPTDbz0.js";import{r as he,t as ge}from"./create-DAcGflIF.js";import{t as _e}from"./misc-DDs3MKLt.js";import{_ as ve,c as ye,f as be,g as xe,l as Se,o as Ce,p as we,r as Te,s as Ee}from"./light-C4Do2tPg.js";import{a as Y,i as De,n as Oe,r as X,t as ke}from"./text-nLwRapxP.js";import{i as Ae,n as je,r as Me,t as Ne}from"./useMobileViewport-C_g6n_VR.js";import{t as Pe}from"./Close-CioEM7XQ.js";import{r as Fe,t as Ie}from"./Icon-JAwANUBo.js";import{t as Le}from"./Alert-CHDA_-Qp.js";import{A as Z,C as Re,F as ze,M as Be,P as Ve,S as He,d as Ue,i as We,l as Ge,n as Ke,r as qe,t as Je}from"./index-EyI18SaY.js";import{t as Ye}from"./CodeSlashOutline-BiQPNLo2.js";import{t as Xe}from"./PanelUpdateAction-DYZIoMJu.js";var Ze=G({name:`ChevronDownFilled`,render(){return o(`svg`,{viewBox:`0 0 16 16`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`},o(`path`,{d:`M3.20041 5.73966C3.48226 5.43613 3.95681 5.41856 4.26034 5.70041L8 9.22652L11.7397 5.70041C12.0432 5.41856 12.5177 5.43613 12.7996 5.73966C13.0815 6.0432 13.0639 6.51775 12.7603 6.7996L8.51034 10.7996C8.22258 11.0668 7.77743 11.0668 7.48967 10.7996L3.23966 6.7996C2.93613 6.51775 2.91856 6.0432 3.20041 5.73966Z`,fill:`currentColor`}))}}),Qe=m&&`loading`in document.createElement(`img`);function $e(e={}){let{root:t=null}=e;return{hash:`${e.rootMargin||`0px 0px 0px 0px`}-${Array.isArray(e.threshold)?e.threshold.join(`,`):e.threshold??`0`}`,options:Object.assign(Object.assign({},e),{root:(typeof t==`string`?document.querySelector(t):t)||document.documentElement})}}var et=new WeakMap,tt=new WeakMap,nt=new WeakMap,rt=(e,t,n)=>{if(!e)return()=>{};let r=$e(t),{root:i}=r.options,a,o=et.get(i);o?a=o:(a=new Map,et.set(i,a));let s,c;a.has(r.hash)?(c=a.get(r.hash),c[1].has(e)||(s=c[0],c[1].add(e),s.observe(e))):(s=new IntersectionObserver(e=>{e.forEach(e=>{if(e.isIntersecting){let t=tt.get(e.target),n=nt.get(e.target);t&&t(),n&&(n.value=!0)}})},r.options),s.observe(e),c=[s,new Set([e])],a.set(r.hash,c));let l=!1,u=()=>{l||(tt.delete(e),nt.delete(e),l=!0,c[1].has(e)&&(c[0].unobserve(e),c[1].delete(e)),c[1].size<=0&&a.delete(r.hash),a.size||et.delete(i))};return tt.set(e,u),nt.set(e,n),u},it=g(`n-avatar-group`),at=O(`avatar`,`
...
`,[O(`layout-scroll-container`,`
 ...
 top: 0;
 bottom: 0;
 `)]),Ot={embedded:Boolean,position:Et,nativeScrollbar:{type:Boolean,default:!0},scrollbarProps:Object,onScroll:Function,contentClass:String,contentStyle:{type:[String,Object],default:``},hasSider:Boolean,siderPlacement:{type:String,default:`left`}},kt=g(`n-layout`);function At(e){return G({name:e?`LayoutContent`:`Layout`,props:Object.assign(Object.assign({},R.props),Ot),setup(e){let t=H(null),n=H(null),{mergedClsPrefixRef:r,inlineThemeDisabled:i}=B(e),a=R(`Layout`,`-layout`,Dt,wt,e,r);function o(r,i){if(e.nativeScrollbar){let{value:e}=t;e&&(i===void 0?e.scrollTo(r):e.scrollTo(r,i))}else{let{value:e}=n;e&&e.scrollTo(r,i)}}J(kt,e);let s=0,c=0,l=t=>{var n;let r=t.target;s=r.scrollLeft,c=r.scrollTop,(n=e.onScroll)==null||n.call(e,t)};ie(()=>{if(e.nativeScrollbar){let e=t.value;e&&(e.scrollTop=c,e.scrollLeft=s)}});let u={display:`flex`,flexWrap:`nowrap`,width:`100%`,flexDirection:`row`},d={scrollTo:o},f=L(()=>{let{common:{cubicBezierEaseInOut:t},self:n}=a.value;return{"--n-bezier":t,"--n-color":e.embedded?n.colorEmbedded:n.color,"--n-text-color":n.textColor}}),p=i?I(`layout`,L(()=>e.embedded?`e`:``),f,e):void 0;return Object.assign({mergedClsPrefix:r,scrollableElRef:t,scrollbarInstRef:n,hasSiderStyle:u,mergedTheme:a,handleNativeElScroll:l,cssVars:i?void 0:f,themeClass:p?.themeClass,onRender:p?.onRender},d)},render(){var t;let{mergedClsPrefix:n,hasSider:r}=this;(t=this.onRender)==null||t.call(this);let i=r?this.hasSiderStyle:void 0;return o(`div`,{class:[this.themeClass,e&&`${n}-layout-content`,`${n}-layout`,`${n}-layout--${this.position}-positioned`],style:this.cssVars},this.nativeScrollbar?o(`div`,{ref:`scrollableElRef`,class:[`${n}-layout-scroll-container`,this.contentClass],style:[this.contentStyle,i],onScroll:this.handleNativeElScroll},this.$slots):o(A,Object.assign({},this.scrollbarProps,{onScroll:this.onScroll,ref:`scrollbarInstRef`,theme:this.mergedTheme.peers.Scrollbar,themeOverrides:this.mergedTheme.peerOverrides.Scrollbar,contentClass:this.contentClass,contentStyle:[this.contentStyle,i]}),this.$slots))}})}var jt=At(!1),Mt=At(!0),Nt=O(`layout-header`,`
 transition:
 color .3s var(--n-bezier),
 background-color .3s var(--n-bezier),
 box-shadow .3s var(--n-bezier),
...
`,[S(`bordered`,[k(`border`,`
 ...
 `)]),e(`disabled`,[e(`selected, child-active`,[f(`&:focus-within`,Wt)]),S(`selected`,[$(null,[k(`icon`,`color: var(--n-item-icon-color-active-hover-horizontal);`),O(`menu-item-content-header`,`
 ...
 `,[f(`a`,`color: var(--n-item-text-color-child-active-hover-horizontal);`),k(`extra`,`color: var(--n-item-text-color-child-active-hover-horizontal);`)])])]),$(`border-bottom: 2px solid var(--n-border-color-horizontal);`,Wt)]),O(`menu-item-content-header`,[f(`a`,`color: var(--n-item-text-color-horizontal);`)])])]),e(`responsive`,[O(`menu-item-content-header`,`
 overflow: hidden;
 ...
 `)]),e(`disabled`,[e(`selected, child-active`,[f(`&:focus-within`,Ut)]),S(`selected`,[$(null,[k(`arrow`,`color: var(--n-arrow-color-active-hover);`),k(`icon`,`color: var(--n-item-icon-color-active-hover);`),O(`menu-item-content-header`,`
 ...
 `,[f(`a`,`color: var(--n-item-text-color-child-active-hover);`),k(`extra`,`color: var(--n-item-text-color-child-active-hover);`)])])]),S(`selected`,[$(null,[f(`&::before`,`background-color: var(--n-item-color-active-hover);`)])]),$(null,Ut)]),k(`icon`,`
 grid-area: icon;
 ...
 overflow: hidden;
 padding: 0;
 `,[Re({duration:`.2s`})])]),O(`menu-item-group`,[O(`menu-item-group-title`,`
 margin-top: 6px;
 color: var(--n-group-text-color);
 cursor: default;
 font-size: .93em;
