...
`,[v(`bordered`,[w(`border`,`
 ...
 overflow: hidden;
 padding: 0;
 `,[je({duration:`.2s`})])]),C(`menu-item-group`,[C(`menu-item-group-title`,`
 margin-top: 6px;
 color: var(--n-group-text-color);
 cursor: default;
 font-size: .93em;
