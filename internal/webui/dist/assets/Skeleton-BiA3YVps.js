import{v as H,S as N,A as b,y as O,d as A,s as p,a9 as E,aH as V,a5 as j,G as L,H as w,m as k,O as T,az as y}from"./index-BHx4uX-4.js";let S=!1;function $(){if(H&&window.CSS&&!S&&(S=!0,"registerProperty"in window?.CSS))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function F(e){const{heightSmall:i,heightMedium:r,heightLarge:s,borderRadius:a}=e;return{color:"#eee",colorEnd:"#ddd",borderRadius:a,heightSmall:i,heightMedium:r,heightLarge:s}}const G={common:N,self:F},I=b([O("skeleton",`
 height: 1em;
 width: 100%;
 transition:
