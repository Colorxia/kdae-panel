import{v as N,S as A,A as b,y as H,d as O,s as p,a9 as E,az as V,a5 as j,G as L,H as w,m as k,O as T,aA as y}from"./index-D_TUPEm5.js";let S=!1;function $(){if(N&&window.CSS&&!S&&(S=!0,"registerProperty"in window?.CSS))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function F(e){const{heightSmall:i,heightMedium:r,heightLarge:s,borderRadius:a}=e;return{color:"#eee",colorEnd:"#ddd",borderRadius:a,heightSmall:i,heightMedium:r,heightLarge:s}}const G={common:A,self:F},I=b([H("skeleton",`
 height: 1em;
 width: 100%;
 transition:
